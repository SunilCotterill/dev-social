      ...
      <Routes>
        ...
        <section className="container">
          ...
          <Routes>
            ...
            <Route path='/profiles' element={<Profiles />} exact />
            ...
            <Route path='/posts' element={<PrivateRoute><Posts /></PrivateRoute>} exact />
            <Route path='/posts/:id' element={<PrivateRoute><Post /></PrivateRoute>} exact />
